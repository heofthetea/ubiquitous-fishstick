...
public class ProgressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.progress_drawer_layout), (v, insets) -> {
    ...
    private void setUpUiElements(){
        ...
        Spinner modules = findViewById(R.id.progress_spinner_module);
        ...
        TextView seekText = findViewById(R.id.progress_seek_bar_progress_text);
        SeekBar seekbar = findViewById(R.id.progress_seek_bar_progress);
        ...
        uiDatePicker.handleDatePicker(findViewById(R.id.progress_edit_text_due_date), this);

        //Initial setup of SideBar-Navigation-Menu
        UiSideMenu uiSideMenu = new UiSideMenu(this,findViewById(R.id.progress_drawer_layout));
        Toolbar toolbar = findViewById(R.id.progress_toolbar);
        setSupportActionBar(toolbar);
        uiSideMenu.handleSideMenu(findViewById(R.id.nav_progress_view),toolbar, getSupportActionBar());
    }
    private void handleButton(){
        Button buttonAdd = findViewById(R.id.btn_add_progress);
        buttonAdd.setOnClickListener(view -> addProgress());
    }
    private void addProgress() {

        /*Spinner spinner =  findViewById(R.id.progress_spinner_module);
        EditText editLecture = findViewById(R.id.homework_edit_text_lecture);
        String topic = editLecture.getText().toString();
        EditText dueDate = findViewById(R.id.progress_edit_text_due_date);
        EditText editDesc = findViewById(R.id.progress_edit_text_description);
        SeekBar seekBar = findViewById(R.id.progress_seek_bar_progress);
